...
x, bfgs_back_values, runtimes, bfgs_xs,iterations = alg.bfgs( hw_func.rosenbrock_func, initial_x, 1.0, eps, maximum_iterations, alg.backtracking_line_search)
