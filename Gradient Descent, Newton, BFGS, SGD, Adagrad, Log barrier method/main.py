...
func_stochastic = lambda x, order: test_func.svm_objective_function_stochastic( x, features, labels, order, minibatch_size)
func = lambda x, order: test_func.svm_objective_function( x, features, labels, order )
